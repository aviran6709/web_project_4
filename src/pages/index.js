...
import {cardSection ,popupAddBtn, initialCards ,settingsObject ,nameInput,jobInput, profilePopup,creatCardForm,editButton} from "../scripts/utils/constants.js"
...
jobInput.value = popupProfile.getUserInfo().job;
popupUserInfo.open();
})
